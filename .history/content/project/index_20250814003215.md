...
### 研究目的
二重変異体のキイロショウジョウバエ幼虫の行動は、その特徴のない個体の形状によって行動を追跡したり、解析することが困難でした。そこで、私たちの研究グループは深層学習フレームワークYOLOを応用した、キイロショウジョウバエ幼虫行動解析モデル「DOLO」を提案しました。このモデルによってこの変異体とコントロールの比較行動解析が可能になりました。
...
### 研究成果
このモデルによってこの変異体とコントロールの比較行動解析が可能になりました。
