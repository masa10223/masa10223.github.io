...
<input type="radio" name="home-pubs-tab-ja" id="home-pubs-tab-ja-papers" checked>
<input type="radio" name="home-pubs-tab-ja" id="home-pubs-tab-ja-preprints">
<input type="radio" name="home-pubs-tab-ja" id="home-pubs-tab-ja-talks">
<input type="radio" name="home-pubs-tab-ja" id="home-pubs-tab-ja-presentations">
<div class="home-pubs-tab-labels" role="tablist" aria-label="Publication categories">
<label for="home-pubs-tab-ja-papers">論文</label>
<label for="home-pubs-tab-ja-preprints">Preprints</label>
<label for="home-pubs-tab-ja-talks">招待講演</label>
<label for="home-pubs-tab-ja-presentations">口頭発表</label>
</div>
...
<p class="home-pubs-venue">Evolution & Development (2024年3月)</p>
...
<p class="home-pubs-venue">npj Systems Biology and Applications (2023年7月6日)</p>
<div class="home-pubs-links">
...
<p class="home-pubs-venue">bioRxiv (2025年4月16日)</p>
<div class="home-pubs-links">
...
<p class="home-pubs-authors">○Masato TSUTSUMI, Nen Saito, Daisuke Koyabu, Chikara Furusawa</p>
<p class="home-pubs-venue">Preprint (2022年5月19日)</p>
</article>
</section>
...
<a href='{{< relref "publication/index.md" >}}'>すべての研究業績を見る →</a>
</div>
